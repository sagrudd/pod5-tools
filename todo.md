...
## Slice 14: Dockerized POD5 Parser Backend
...
- [x] Document `POD5_TOOLS_DOCKER`, `POD5_TOOLS_POD5_IMAGE`, and image build
  workflow.
- [x] Add tests using a fake Docker executable.

## Slice 15: Rust-Native POD5 Reader Evaluation

- [ ] Build a representative fixture corpus with expected metadata generated by
  the Docker backend.
- [ ] Spike direct Rust parsing for POD5 layout, schema, run metadata, read
  counts, and acquisition timing.
- [ ] Compare correctness, performance, packaging complexity, and maintenance
  risk against the Docker backend.
- [ ] Decide whether Rust-native parsing should become a supported backend.
